    ...
    <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white">CRM Sales Analyst</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Log in to access your account insights.</p>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-500">
            (Use 'jsmith' or 'adoe' to log in)
          </p>
        </div>
